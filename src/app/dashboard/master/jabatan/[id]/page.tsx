...
const breadcrumbItems: BreadcrumbItem[] = [
  ...
  { label: "Master Data" },
  { label: "Jabatan", href: "/dashboard/master/jabatan" },
...
export default function DetailJabatanPage() {
  ...
  useEffect(() => {
    ...
    supabase
      ...
      .then(({ data: result, error: err }) => {
        ...
        else setData(result as Jabatan)
        setLoading(false)
      })
  }, [id])
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-8">
      <BreadcrumbNav items={breadcrumbItems} />
      <PageHeader
        title={data.nama || "Detail Jabatan"}
        description="Informasi lengkap"
        actions={
          <div className="flex gap-2">
            <Button variant="back" onClick={() => router.push("/dashboard/master/jabatan")}>
              Kembali
            </Button>
