  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold text-foreground">Buat Quotation</h1>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea {...register('keterangan')} placeholder="Term and conditions, validity period, etc." rows={2} />
            </div>
          </CardContent>
        </Card>
              ...
              <div key={field.id} className="p-4 border rounded-lg space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2">
                    ...
                    <Input type="number" min="0" max="100" step="0.01" {...register(`items.${index}.diskon`)} placeholder="0" />
                  </div>
                  <div className="space-y-2">
